...
![第一次打开 VS Code 时的界面](/Assets/docs-tutorial-setup-vscode-first-launch.png)
...
![安装中文插件](/Assets/docs-tutorial-setup-vscode-chinese-extension.png)
...
![Git 下载途径示意 1](/Assets/docs-tutorial-setup-git-download-source-1.png)

图 3：Git 下载途径示意图。

![Git 下载途径示意 2](/Assets/docs-tutorial-setup-git-download-source-2.png)
...
![在 VS Code 中登录 GitHub](/Assets/docs-tutorial-setup-vscode-signin-github-source.png)
...
![搜索并选择 RMS-Server/RMS-Docs](/Assets/docs-tutorial-setup-clone-rms-docs-search.png)

图 6：以 `RMS-Docs` 为关键词搜索，并选择 `RMS-Server/RMS-Docs`。

![服务器文档已成功拷贝到本地](/Assets/docs-tutorial-setup-clone-rms-docs-local-copy.png)
